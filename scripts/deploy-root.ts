...
const SITES_REGISTRY: Site[] = [
  ...
  {
    id: 'eng-confusables',
    name: 'まぎらわしい英単語・熟語ノート',
    shortName: 'まぎらわしい英単語・熟語ノート',
    tag: '英語・語彙',
    target: '大学受験・TOEIC・英検の学習者 / スペル・意味・品詞・発音・熟語の5カテゴリ',
    desc: 'affect/effect、lie/lay、look after/look up to…スペル・意味・品詞・発音が似た英単語と、前置詞ひとつで意味が変わる熟語・句動詞を、引いてすぐ違いと使い分けがわかる逆引きの比較リファレンス。比較表と例文つき。',
    features: [
      '混同ペアごとの比較表で違いを見分け',
      '熟語・句動詞は主要動詞（take・get・put ほか）のハブ頁から辿れる',
      '単語で検索・カテゴリで絞り込める逆引き形式',
      '各ペアに例文・覚え方・確認問題つき',
    ],
    sitemapMeta: '混同ペアの比較／スペル・意味・品詞・発音が似た英単語と、熟語・句動詞の違いと使い分け',
    sitemapPages: [
      { label: 'トップ・検索', subpath: '' },
      { label: 'このサイトについて', subpath: 'about/' },
      { label: 'プライバシーポリシー', subpath: 'privacy/' },
    ],
    aboutDesc: '混同しやすい英単語と熟語・句動詞を、スペル・意味・品詞・発音・熟語の5カテゴリで整理。1ペア1ページの比較表で違いと使い分けを引ける逆引きリファレンス。',
    useCaseLabel: '似た英単語・熟語の使い分けを確認したい方',
    useCaseDetail: '<a href="/eng-confusables/">まぎらわしい英単語・熟語ノート</a>で affect/effect・lie/lay のような単語の違いに加えて、look after／look up to のような熟語・句動詞の使い分けも、比較表と例文で引いて確認できます。',
    changefreq: 'weekly',
    priority: '0.8',
  },
  {
  ...
  },
  {
    id: 'snowpark-guide',
    name: 'Snowpark 実践ガイド',
    shortName: 'Snowpark 実践ガイド（基礎知識＋DataFrame API 逆引き）',
    tag: '技術リファレンス',
    target: 'Snowpark Pythonを業務で使うデータエンジニア・アナリスト',
    desc: 'Snowpark Pythonのアーキテクチャ・Spark比較・料金構造・MLといった基礎知識と、DataFrame/Column APIをPolarsの同等コードと並べて確認できる逆引きリファレンスをまとめたサイト。',
    features: [
      '基礎知識6分野（アーキテクチャ／vs Spark／vs Polars総論／UDF・UDTF・SPROC／料金／ML）と、1メソッド=1ページの関数リファレンスの2本柱',
      'Polarsコードは実行確認済み、Snowparkコードは静的検証（inspect.signature/hasattr）済み',
      '各ページに検証日・ライブラリバージョン・公式リファレンスURLを明記',
    ],
    sitemapMeta: 'Snowpark実践ガイド／基礎知識＋DataFrame API逆引き（⇄Polars）比較／順次拡張中',
    sitemapPages: [
      { label: 'トップ・検索', subpath: '' },
      { label: 'このサイトについて', subpath: 'about/' },
      { label: 'プライバシーポリシー', subpath: 'privacy/' },
    ],
    aboutDesc: 'Snowpark Pythonの基礎知識とDataFrame/Column APIの逆引き比較。挙動の違いと移行時の落とし穴、検証済みコード例つき。',
    useCaseLabel: 'Snowparkを業務で使い始めた・使うことを検討している方',
    useCaseDetail: '<a href="/snowpark-guide/">Snowpark 実践ガイド</a>で、アーキテクチャ・料金・MLなどの基礎知識から、select・with_columns・group_byなどのメソッドをSnowparkとPolarsのコードで並べて確認できる逆引きリファレンスまで学べます。',
    changefreq: 'weekly',
    priority: '0.8',
  },
  {
    id: 'capital-quiz',
    name: '世界の首都クイズ',
    shortName: '世界の首都クイズ（国旗・位置・タイムアタックで覚える地理ゲーム）',
    tag: 'ゲーム',
    target: '世界地理が好きな中高生〜大人 / 遊びながら国と首都を覚えたい方',
    desc: '1回5問・1分で遊べる世界の首都クイズ。首都名だけでなく国旗と地図上の位置からも出題し、答えるたびに実座標の世界地図で場所を確かめられます。自己ベスト・196か国の到達度・間違えた国だけの復習・60秒のタイムアタックつき。「訳ありの首都」は外務省の公表情報にもとづいて解説します。',
    features: [
      '地域別・国旗・位置・タイムアタック・訳ありトリビアの5つの遊び方（すべて1回5問・1分）',
      '自己ベストと196か国の到達度が残り、間違えた国だけを復習できる',
      '200の国・地域それぞれに個別ページ（首都・正式名称・出典・訳あり解説・習得バッジ）',
      '出典はすべて外務省の公表情報。国ごとにMOFAの一次情報ページへ直接リンク',
    ],
    sitemapMeta: '世界の首都クイズ／地域別・国旗・位置・タイムアタック・訳ありトリビアと国別ページ200件',
    sitemapPages: [
    ...
    aboutDesc: '1回5問・1分で遊べる世界の首都クイズ。国旗・位置・タイムアタックの遊び方と、自己ベスト・到達度・復習つき。「訳あり」の首都は外務省の公表情報にもとづいて解説。',
    useCaseLabel: '遊びながら世界の国と首都を覚えたい方',
    useCaseDetail: '<a href="/capital-quiz/">世界の首都クイズ</a>で、国旗や地図の位置からも出題される1回5問のクイズに挑戦できます。答えるたびに世界地図で場所を確かめられ、自己ベストと196か国の到達度が残ります。「訳ありの首都」は外務省の公表情報にもとづく解説つきです。',
    changefreq: 'monthly',
    priority: '0.7',
  },
  {
    id: 'fukagawa-history',
    name: '深川の歴史と文化ガイド',
    shortName: '深川の歴史と文化ガイド（八幡祭り・芭蕉・木場・深川めし）',
    tag: '歴史・散策',
    target: '深川を歩く方、江戸東京の歴史と文化に興味のある方',
    desc: '東京都江東区の深川を、地名の由来から通史、富岡八幡宮の深川八幡祭り、松尾芭蕉と辰巳芸者、木場の材木業と深川めしまで、一次情報で確かめながら紹介します。街路や公園の形に残る運河の痕跡は実座標地図つきでたどれます。',
    features: [
      '地名の由来・通史・社寺・名物・産業・文化を12記事で通して読める',
      '油堀川の川幅28m、和倉橋の親柱など、現地で確認できる具体的な数値と実物を明記',
      '江東区公式、深川江戸資料館、首都高速道路株式会社、ROIS-DS人文学オープンデータ共同利用センターなどの一次情報で事実確認',
    ],
    sitemapMeta: '深川の歴史と文化ガイド／地名の由来・通史・社寺・名物・産業・文化の記事12本（富岡八幡宮、芭蕉、木場、深川めしほか）',
    sitemapPages: [
    ...
    aboutDesc: '深川の地名の由来、通史、富岡八幡宮と深川八幡祭り、芭蕉と辰巳芸者、木場の材木業と深川めしを一次情報で紹介。街路に残る運河の痕跡は実座標地図つき。',
    useCaseLabel: '深川の歴史と文化をひととおり知りたい方',
    useCaseDetail: '<a href="/fukagawa-history/">深川の歴史と文化ガイド</a>で、地名の由来から富岡八幡宮の祭礼、芭蕉と辰巳芸者、木場の材木業と深川めしまでを一次情報で確かめながら読めます。街路に残る運河の痕跡は実座標地図つきでたどれます。',
    changefreq: 'monthly',
    priority: '0.7',
  },
  {
    id: 'yanaka-history',
    name: '谷中の歴史と文化ガイド',
    shortName: '谷中の歴史と文化ガイド（寺町・名物・災害史）',
    tag: '歴史・文化',
    target: '谷中を歩く方、東京の下町の歴史と文化に興味のある方',
    desc: '東京都台東区の谷中を、地名の由来から寺町の成り立ち、天王寺や観音寺などの社寺、谷中生姜と羽二重団子、石工や植木職人の生業まで一次情報で紹介します。戦前の木造家屋が残る理由は、関東大震災と東京大空襲の被災境界から読み解きます。',
    features: [
      '地名の由来・寺町の成立・社寺・名物・産業・災害史を12記事で通して読める',
      '谷中生姜や羽二重団子が実際にどこで作られたか（現・荒川区）まで明記',
      '総務省、台東区公式、JA東京中央会、国立国会図書館レファレンス協同データベースなどの一次情報で事実確認',
    ],
    sitemapMeta: '谷中の歴史と文化ガイド／地名の由来・寺町・社寺・名物・産業・災害史の記事12本',
    sitemapPages: [
    ...
    aboutDesc: '谷中の地名の由来、寺町の成立、社寺、谷中生姜と羽二重団子、石工や植木職人の生業を一次情報で紹介。戦前の町並みが残る理由は震災と空襲の被災境界から解説。',
    useCaseLabel: '谷中の歴史と文化をひととおり知りたい方',
    useCaseDetail: '<a href="/yanaka-history/">谷中の歴史と文化ガイド</a>で、寺町の成り立ちから谷中生姜や羽二重団子の由来まで読めます。戦前の町並みが残る理由も、震災と空襲の被災境界から確かめられます。',
    changefreq: 'monthly',
    priority: '0.7',
  },
  {
...
<html lang="ja">
  <head>
    ...
    <script>
      // 旧URL（stats-pre1 がルート直下にあった時代の /1.X-name/ や /2.X-name/ 等）→ /stats-pre1/ 配下へ
