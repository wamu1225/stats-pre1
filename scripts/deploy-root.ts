...
const SITES_REGISTRY: Site[] = [
  ...
  },
  {
    ...
    desc: '東京都江東区深川地区の不自然に広い道や蛇行する緑地は、江戸時代の運河が埋め立てられた跡。採荼庵跡、富岡八幡宮、木場公園など、実在する7地点をつなぐ散歩ルートで、街の形に残る水路の記憶をたどります。',
    features: [
      '採荼庵跡から木場公園まで、実在7地点を地理的順路でつなぐ散歩ルート',
      '各地点で「かつて何があったか」と「今何が見えるか」を対で提示',
      '江東区公式、深川江戸資料館、首都高速道路株式会社などの一次情報で事実確認',
    ],
    sitemapMeta: '深川さんぽ史／運河跡を歩く散歩ルートと記事8本（採荼庵、富岡八幡宮、木場公園ほか）',
    sitemapPages: [
