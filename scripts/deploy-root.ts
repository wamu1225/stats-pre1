...
const SITES_REGISTRY: Site[] = [
  ...
  },
  {
    ...
    desc: '東京都江東区深川地区の不自然に広い道や蛇行する緑地は、江戸時代の運河が埋め立てられた跡、または今も流れる運河そのもの。小名木川から木場まで、実座標地図つきの9地点をたどりながら、川幅や開削年、現存する橋の親柱など、確かめられる事実で水路の記憶をたどります。',
    features: [
      '小名木川、油堀川、大横川など運河そのものの跡や現存する運河をつなぐ、実座標地図つきの散歩ルート',
      '油堀川の川幅28m、和倉橋の親柱など、現地で確認できる具体的な数値と実物を明記',
      '江東区公式、深川江戸資料館、首都高速道路株式会社、ROIS-DS人文学オープンデータ共同利用センターなどの一次情報で事実確認',
    ],
    sitemapMeta: '深川さんぽ史／運河をたどる実座標地図つきの散歩ルートと記事10本（小名木川、油堀川、木場ほか）',
    sitemapPages: [
    ...
    aboutDesc: '深川の街路や公園の形に残る運河の痕跡、または今も流れる運河そのものを、実座標地図つきの散歩ルートで紹介。江東区公式、深川江戸資料館などの一次情報で事実確認。',
    useCaseLabel: '深川を歩く前に運河の歴史を知りたい方',
    useCaseDetail: '<a href="/fukagawa-history/">深川さんぽ史</a>で、小名木川から木場まで、運河そのものの跡や現存する運河をつなぐ散歩ルートをたどりながら、道路や公園の形に残る運河の記憶を実座標地図と具体的な数値つきで知ることができます。',
    changefreq: 'monthly',
    priority: '0.7',
  },
  {
    id: 'yanaka-history',
    name: '谷中 焼け残った町',
    shortName: '谷中 焼け残った町（震災と空襲の境界線から読み解くガイド）',
    tag: '歴史・災害史',
    target: '谷中を歩く方、東京の戦災史に興味のある方',
    desc: '東京都台東区谷中地区になぜ戦前の木造家屋が残るのか。関東大震災と東京大空襲、1945年3月4日の空襲による被災エリアと焼け残ったエリアを、総務省や台東区公式の資料にもとづいて対比します。',
    features: [
      '被災したエリアと焼け残ったエリアを2カラムで対比するトップページ',
      '三四真地蔵尊、谷中霊園、谷中銀座など実在する地点を各エリアに対応',
      '総務省、台東区公式、東京都公園協会などの一次情報で事実確認',
    ],
    sitemapMeta: '谷中 焼け残った町／震災と空襲の被災境界を対比するガイド、記事8本',
    sitemapPages: [
      { label: 'トップ（エリア対比）', subpath: '' },
      { label: '記事一覧', subpath: 'articles/' },
      { label: 'このサイトについて', subpath: 'about/' },
      { label: 'プライバシーポリシー', subpath: 'privacy/' },
    ],
    aboutDesc: '谷中が戦前の町並みを残す理由を、関東大震災と東京大空襲の被災境界から解説。総務省、台東区公式などの一次情報で事実確認。',
    useCaseLabel: '谷中を歩く前に戦災史を知りたい方',
    useCaseDetail: '<a href="/yanaka-history/">谷中 焼け残った町</a>で、1945年3月4日の空襲で被災した一角と、震災でも空襲でも焼け残った一角を見比べながら、谷中の町並みが残った理由を知ることができます。',
    changefreq: 'monthly',
    priority: '0.7',
  },
];
